...
s3=boto3.client("s3",aws_access_key_id= "AKIAXJQXRN5D6RFUNIVF", aws_secret_access_key=os.getenv("AWS_SECRET_ID"))
app=Flask(__name__)
...
@app.route('/xml_data')
def get_data():
    xml_data = get_data_from_s3("pythonquerystackoverflow", "stack_overflow_data/data.xml")
